...
GST1_PLUGINS_BASE_CFLAGS = $(TARGET_CFLAGS) $(GSTREAMER1_EXTRA_COMPILER_OPTIONS)
...
GST1_PLUGINS_BASE_DEPENDENCIES += mesa3d
endif

ifeq ($(BR2_PACKAGE_GST1_PLUGINS_BASE_LIB_OPENGL_GBM),y)
GST1_PLUGINS_BASE_WINSYS_LIST += gbm
GST1_PLUGINS_BASE_DEPENDENCIES += libdrm libgudev
endif
