...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PRIVILEGED_REQUEST),y)
WPEFRAMEWORK_CONF_OPTS += -DPRIVILEGEDREQUEST=ON
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_LOCALTRACER),y)
...
define WPEFRAMEWORK_PERMISSIONS
	...
	$(WPEFRAMEWORK_PERSISTENT_ROOT_PERMISSION)
	$(WPEFRAMEWORK_PERSISTENT_PERMISSION)
endef
$(eval $(cmake-package))
