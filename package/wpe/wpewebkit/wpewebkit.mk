...
WPEWEBKIT_VERSION_VALUE = 2.22
WPEWEBKIT_VERSION = 4a3f5e45a87edf439e9d1dfe919e2137972d1bfe
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT2_28),y)
WPEWEBKIT_VERSION_VALUE = 2.28
WPEWEBKIT_VERSION = b57a00058601e648eae87fa5adc865d5cb842b74
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT2_38),y)
WPEWEBKIT_VERSION_VALUE = 2.38
WPEWEBKIT_VERSION = 92ddde7d4bf01dbde7719132c38926ef16e3a57e
endif

ifeq ($(BR2_PACKAGE_WPEWEBKIT2_42),y)
WPEWEBKIT_VERSION_VALUE = 2.42
...
# FIXME: Add an option for USE_GSTREAMER_WEBRTC. Disabling it means libwebrtc is
# enabled, but only if ENABLE_WEB_RTC is ON.
...
WPEWEBKIT_SYMBOL_FLAGS = -g1 -gsplit-dwarf -gz
else ifeq ($(BR2_PACKAGE_WPEWEBKIT_SYMBOLS_LEVEL_2),y)
WPEWEBKIT_SYMBOL_FLAGS = -g2 -gsplit-dwarf -gz
else ifeq ($(BR2_PACKAGE_WPEWEBKIT_SYMBOLS_LEVEL_3),y)
WPEWEBKIT_SYMBOL_FLAGS = -g3 -gsplit-dwarf -gz
endif
...
WPEWEBKIT_COMPILER_FLAGS=$(WPEWEBKIT_SYMBOL_FLAGS) $(WPEWEBKIT_CXXFLAGS) -Wno-cast-align -mrestrict-it
WPEWEBKIT_CONF_OPTS += \
...
WPEWEBKIT_CONF_OPTS += \
	-DUSE_WPEWEBKIT_PLATFORM_BROADCOM=ON
endif
else
WPEWEBKIT_CONF_OPTS += \
...
WPEWEBKIT_CONF_OPTS += \
	-DUSE_WPEWEBKIT_PLATFORM_BCM_NEXUS=ON
...
WPEWEBKIT_CONF_OPTS += \
        -DUSE_WPEWEBKIT_PLATFORM_WESTEROS=ON \
        -DUSE_GSTREAMER_HOLEPUNCH=ON \
        -DUSE_HOLE_PUNCH_GSTREAMER=ON \
        -DUSE_EXTERNAL_HOLEPUNCH=ON \
        -DUSE_WESTEROS_SINK=ON \
        -DUSE_WPEWEBKIT_PLATFORM_REALTEK=ON
endif
