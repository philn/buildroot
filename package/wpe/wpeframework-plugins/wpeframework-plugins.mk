...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_CONTROLLER="BluetoothControl"
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIOSINK_CONTROLLER="BluetoothControl"
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DP_AUDIO_SOURCE="BluetoothAudioSink"
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSOURCE_NAME=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSINK_SDPSERVICE_NAME}
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSOURCE_DESCRIPTION=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSINK_SDPSERVICE_DESCRIPTION}
endif
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSOURCE),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIOSOURCE=ON
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIOSOURCE_CONTROLLER="BluetoothControl"
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSOURCE_CODECSBC), y)
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += sbc
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSOURCE_SDPSERVICE), y)
# This is not an error, these settings are seen from the remote device perspective.
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DP_AUDIO_SINK="BluetoothAudioSource"
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSINK_NAME=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSOURCE_SDPSERVICE_NAME}
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSINK_DESCRIPTION=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIOSOURCE_SDPSERVICE_DESCRIPTION}
endif
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TESTAUTOMATIONTOOLS),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DTEST_AUTOMATION_TOOLS=ON
endif
