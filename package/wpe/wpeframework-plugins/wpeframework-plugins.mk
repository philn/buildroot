...
WPEFRAMEWORK_COBALT_PERMISSION=$(subst ",,$(BR2_PACKAGE_WPEFRAMEWORK_INSTALL_PATH)")/Cobalt r 0550 root $(subst ",,$(WPEFRAMEWORK_COBALT_USER_GROUP)") - - - - -
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHREMOTECONTROL_CONTROLLER="BluetoothControl"
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO),y)
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += sbc
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO=ON
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_LATENCY=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_LATENCY}
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC), y)
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET_LQ),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET=LQ
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET_MQ),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET=MQ
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET_HQ),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET=HQ
else ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET_XQ),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SINK_CODECSBC_PRESET=XQ
endif
endif
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE),y)
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_CODECSBC), y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHAUDIO_SOURCE_CODECSBC_MAXBITPOOL=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_CODECSBC_MAXBITPOOL}
endif
endif
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHSDPSERVER),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER=ON
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_PROVIDER=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHSDPSERVER_PROVIDER}
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK),y)
# This is not an error, these settings are seen from the remote device perspective.
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DP_AUDIO_SOURCE="BluetoothAudio"
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSOURCE_NAME=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_SDPSERVICE_NAME}
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSOURCE_DESCRIPTION=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SINK_SDPSERVICE_DESCRIPTION}
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE),y)
# This is not an error, these settings are seen from the remote device perspective.
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DP_AUDIO_SINK="BluetoothAudio"
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSINK_NAME=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_SDPSERVICE_NAME}
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_BLUETOOTHSDPSERVER_SERVICE_A2DPAUDIOSINK_DESCRIPTION=${BR2_PACKAGE_WPEFRAMEWORK_BLUETOOTHAUDIO_SOURCE_SDPSERVICE_DESCRIPTION}
endif
endif
...
ifeq ($(BR2_PACKAGE_HAS_NEXUS),y)
ifeq ($(BR2_PACKAGE_SDK_RDKVA_SAGEMCOM),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_NXSERVER=OFF
else
